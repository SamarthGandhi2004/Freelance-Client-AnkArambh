...
const ContactUs = () => {
  return (
    <footer id="contact" class="w-full py-14">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto flex flex-col items-center">
               
                <h1 className='text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-red-800'>AnkArambh</h1>
                    <ul className="cursor-pointer text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        <li> <Link to="home" smooth={true} duration={500} className=' text-gray-800 hover:text-gray-900'>Home</Link></li>
                        <li><Link to="services" smooth={true} duration={500} className=' text-gray-800 hover:text-gray-900'>Services</Link></li>
                        <li><Link to="about" smooth={true} duration={500} className=' text-gray-800 hover:text-gray-900'>About</Link></li>
                        <li><Link to="contact" smooth={true} duration={500} className=' text-gray-800 hover:text-gray-900'>Contact Us</Link></li>
                        <li><Link to="faqs" smooth={true} duration={500} className=' text-gray-800 hover:text-gray-900'>FAQs</Link></li>
                    </ul>
                    <div class="flex space-x-10 justify-center items-center mb-14">
                        ...
                        <span className='block text-lg  font-medium bg-red-800 p-4  text-white rounded-full p-5'>
